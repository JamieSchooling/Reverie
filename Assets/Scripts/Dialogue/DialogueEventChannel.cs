...
public class DialogueEventChannel : ScriptableObject
{
    ...
    public void RequestDialogue(Dialogue dialogue) => OnDialogueRequested?.Invoke(dialogue);
    ...
    public void RequestDialogueNode(DialogueNode node) => OnDialogueNodeRequested?.Invoke(node);
